const VNPTSettings = (function () {
    ...
    function applySettings(settings) {
        ...
        if (window.VNPTConfig) {
            window.VNPTConfig.VERSION = '1.1.0';
        }
    }
            ...
            <div class="vnpt-settings-container">
                ...
                <div class="vnpt-settings-footer">
                    <div class="version-info">
                        VNPT HIS Smart Scanner <span class="version-tag" style="cursor: pointer;">v1.1.0</span>
                    </div>
                </div>
            </div>
        `;
    ...
    function init() {
        ...
        syncFromChrome();
        if (window.VNPTLogger) window.VNPTLogger.info('Settings', '✅ Settings v5.0 initialized');
    }
