...
const ICONS = {
    ...
    hoichan: '<svg width="18" height="18" viewBox="0 0 24 24"><defs><linearGradient id="clipGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#f59e0b"/><stop offset="100%" stop-color="#d4a853"/></linearGradient></defs><rect x="6" y="4" width="12" height="18" rx="2" fill="url(#clipGrad)"/><rect x="8" y="2" width="8" height="4" rx="1" fill="#E8E0D4"/><line x1="9" y1="10" x2="15" y2="10" stroke="white" stroke-width="1.5" stroke-linecap="round"/><line x1="9" y1="14" x2="15" y2="14" stroke="white" stroke-width="1.5" stroke-linecap="round"/><line x1="9" y1="18" x2="13" y2="18" stroke="white" stroke-width="1.5" stroke-linecap="round"/></svg>',
    ...
    ai: '<svg width="20" height="20" viewBox="0 0 24 24"><defs><linearGradient id="aiGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#f59e0b"/><stop offset="100%" stop-color="#d4a853"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#aiGrad)"/><path d="M12 7v10M7 12h10" stroke="white" stroke-width="2" stroke-linecap="round"/></svg>',
