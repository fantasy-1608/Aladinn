...
const ICONS = {
    ...
    ai: '<svg width="20" height="20" viewBox="0 0 24 24"><defs><linearGradient id="aiGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#60A5FA"/><stop offset="100%" stop-color="#9ECAFF"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#aiGrad)"/><path d="M12 7v10M7 12h10" stroke="white" stroke-width="2" stroke-linecap="round"/></svg>',
