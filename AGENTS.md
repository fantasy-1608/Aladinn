...
This project is indexed by GitNexus as **Aladinn** (2183 symbols, 3054 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
