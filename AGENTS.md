...
This project is indexed by GitNexus as **Aladinn** (4642 symbols, 6958 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
