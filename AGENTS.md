...
This project is indexed by GitNexus as **Aladinn** (6080 symbols, 9859 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
