...
This project is indexed by GitNexus as **Aladinn** (1223 symbols, 2299 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
