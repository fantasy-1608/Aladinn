...
This project is indexed by GitNexus as **Aladinn** (8196 symbols, 12563 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
