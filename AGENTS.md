...
This project is indexed by GitNexus as **Aladinn** (1177 symbols, 1073 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
